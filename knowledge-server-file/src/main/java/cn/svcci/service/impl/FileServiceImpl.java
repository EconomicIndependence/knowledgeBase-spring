...
public class FileServiceImpl implements FileService {
    ...
    // 阿里云OSS上传文件
    @Override
    public Result uploadFile(cn.svcci.entity.File file) {
        return null;
    }

    // 下载文件
    @Override
    public cn.svcci.entity.File getFileById(String fileId) {
        return null;
    }

    // 获取所有文件
    @Override
    public List<cn.svcci.entity.File> getAllFiles() {
        return List.of();
    }
